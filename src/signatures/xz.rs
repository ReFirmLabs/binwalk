...
use crate::structures::xz::{ parse_xz_header, parse_xz_footer };
...
pub fn xz_parser(file_data: &Vec<u8>, offset: usize) -> Result<signatures::common::SignatureResult, signatures::common::SignatureError> {
