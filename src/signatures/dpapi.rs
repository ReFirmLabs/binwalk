use crate::{signatures::common::{SignatureError, SignatureResult}, structures::dpapi::parse_dpapi_blob_header};
...
pub fn dpapi_magic() -> Vec<Vec<u8>> {
    vec![b"\x01\x00\x00\x00\xD0\x8c\x9d\xdf\x01\x15\xd1\x11\x8c\x7a\x00\xc0\x4f\xc2\x97\xeb"
        .to_vec()]
}
