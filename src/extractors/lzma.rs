use lzma;
use crate::extractors::common::{ create_file, safe_path_join, Extractor, ExtractorType, ExtractionResult };

// Defines the internal extractor function for decompressing gzip data
pub fn lzma_extractor() -> Extractor {
    return Extractor { utility: ExtractorType::Internal(lzma_decompress), ..Default::default() };
}

pub fn lzma_decompress(file_data: &Vec<u8>, offset: usize, output_directory: Option<&String>) -> ExtractionResult {
