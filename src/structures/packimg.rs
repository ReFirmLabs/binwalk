...
pub fn parse_packimg_header(packimg_data: &[u8]) -> Result<PackIMGHeader, structures::common::StructureError> {
    ...
    if packimg_data.len() > PACKIMG_HEADER_SIZE {
        ...
        let packimg_header = structures::common::parse(&packimg_data[0..PACKIMG_HEADER_SIZE], &packimg_structure, "little");
