...
function debian
{
	...
	$SUDO apt-get -y install git build-essential mtd-utils zlib1g-dev libfuzzy2 liblzma-dev ncompress gzip bzip2 tar arj p7zip p7zip-full openjdk-6-jdk
...
function redhat
{
	...
	$SUDO yum install -y git mtd-utils unrar zlib1g-dev libfuzzy2 liblzma-dev xz-devel compress gzip bzip2 tar arj p7zip p7zip-full openjdk-6-jdk
